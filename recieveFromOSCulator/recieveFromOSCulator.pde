...
void mousePressed() {
  ...
  OscMessage myMessage = new OscMessage("/proTopro");  // starts with an ADDRESS PATTERN --> = / + any string you like
...
void oscEvent(OscMessage theOscMessage) {
  println("raw" + theOscMessage);
  /* print the address pattern and the typetag of the received OscMessage */
  println("### osculatorRecieve received an osc message from osculator.");
